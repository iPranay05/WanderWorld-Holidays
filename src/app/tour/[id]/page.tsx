            ...
            <div className="container mx-auto px-4 py-10">
              <div className="flex items-center mb-2">
                ...
                <div className="flex items-center text-white">
                  <span className="mr-1 text-yellow-400"><i className="fas fa-star"></i></span>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-lg p-6 mb-8 sticky top-24">
              ...
              <div className="mb-4">
                ...
                <p className="text-3xl font-bold text-emerald-600 mb-4">{selectedTour.price}</p>
                ...
                <a 
                  href={`mailto:wanderworldandco@gmail.com?subject=Inquiry about ${selectedTour.name}&body=Hi, I'm interested in learning more about ${selectedTour.name}.`}
